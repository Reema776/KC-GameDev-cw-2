...
public class cw2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        print("the vill hero's name is " + villainName + " his hight is" + vililanHeight + ", his age is around " + villainAge + " years old and his superpower is " + villainSuperPower);
        ...
        print("the vill hero's name is " + villainName + " his hight is" + vililanHeight + ", his age is around " + villainAge + " years old and his superpower is " + villainSuperPower1 );
